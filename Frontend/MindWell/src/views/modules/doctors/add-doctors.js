                        ...
                        <Form>
                           <Row>
                              ...
                              <div className="form-group col-md-4">
                                 ...
                                 <Form.Control type="text" className="form-control my-2" id="mname" placeholder="Middle Name" />
                              </div>
                              <div className="form-group col-md-4">
                              ...
                              <Form.Group className="col-md-4">
                                 ...
                                 <Form.Control type="text" className="form-control my-2" id="fname" placeholder="Email" />
                              </Form.Group>
                              <div className="form-group col-md-4">
                                 <Form.Label className="mb-0" htmlFor="lname">Password:</Form.Label>
                                 <Form.Control type="password" className="form-control my-2" id="mname" placeholder="Password" />
                              </div>
                              <div className="form-group col-md-4">
                                 <Form.Label className="mb-0" htmlFor="lname">Confirm Password:</Form.Label>
                                 <Form.Control type="password" className="form-control my-2" id="lname" placeholder="Confirm Password" />
                              </div>
                              ...
                              <Form.Group className="col-md-4">
                                 ...
                                 <Form.Control type="text" className="form-control my-2" id="fname" placeholder="District" />
                              </Form.Group>
                              <div className="form-group col-md-4">
                                 <Form.Label className="mb-0" htmlFor="lname">City:</Form.Label>
                                 <Form.Control type="text" className="form-control my-2" id="mname" placeholder="City" />
                              </div>
                              <div className="form-group col-md-4">
                                 <Form.Label className="mb-0" htmlFor="lname">State:</Form.Label>
                                 <Form.Control type="text" className="form-control my-2" id="lname" placeholder="State" />
                              </div>
